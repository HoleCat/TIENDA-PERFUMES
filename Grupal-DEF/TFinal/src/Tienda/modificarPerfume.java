...
public class modificarPerfume extends JDialog implements ActionListener {
	...
	public modificarPerfume() {
		...
		txtAño.setBounds(153, 116, 108, 20);
		...
		btnCerrar.setBounds(298, 40, 98, 23);
		contentPanel.add(btnCerrar);
		
		btnGuardar = new JButton("GUARDAR");
		btnGuardar.addActionListener(this);
		btnGuardar.setBounds(298, 90, 98, 23);
		...
		txtAño.setText(""+ventanaPrincipal.año0);
	...
	protected void actionPerformedCboNM(ActionEvent arg0) {
		...
		mostrarInfoPerfume(año,casa,contenido,precio);
		mostrarImagen(posi);
	}
	int getPosi() {
	...
	int getAño(int posi) {
		switch (posi) {
		case 0: return ventanaPrincipal.año0;
		case 1: return ventanaPrincipal.año1;
		case 2: return ventanaPrincipal.año2;
		case 3: return ventanaPrincipal.año3;
		default: return ventanaPrincipal.año4;
		}
	}
	...
	void mostrarInfoPerfume(int año, String casa, double contenido, double precio)
	{
	...
	void mostrarImagen(int posi) {
		...
		default : lblImage.setIcon(new ImageIcon(modificarPerfume.class.getResource("/img/PerfumeAlcazar.jpg"))); break;
		}
	}
	...
	void getAño2(int posi) {
		switch (posi) {
		case 0 : ventanaPrincipal.año0=Integer.parseInt(txtAño.getText()); break;
		case 1 : ventanaPrincipal.año1=Integer.parseInt(txtAño.getText()); break;
		case 2 : ventanaPrincipal.año2=Integer.parseInt(txtAño.getText()); break;
		case 3 : ventanaPrincipal.año3=Integer.parseInt(txtAño.getText()); break;
		default : ventanaPrincipal.año4=Integer.parseInt(txtAño.getText()); break;
		}
	}
